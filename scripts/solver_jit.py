...
@njit(cache=True)
def _run_core_combined(state, neighbor_sum, is_conflicted, degree, offsets, nbrs,
...
def petford_welsh_jit(graph, A=1.0, B=1.5, b=18, max_iters=1000, rng=None, target=None, init_fn=None):
