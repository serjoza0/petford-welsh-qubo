...
class CSRGraph(NamedTuple):
    ...
    def check(g: "CSRGraph"):
        ...
        * every vertex's degree (``offsets[v+1] - offsets[v]``) is
          non-negative -- isolated vertices (degree 0) are allowed;
        * every value in ``nbrs`` is a valid vertex index in ``0 .. n-1``.
        """
